...
def bloom_query(param_iv):
   ...
   #print (int(encrypted1.encode('hex'),16))
   bloom[(int(cipher1_text)%58)] += 1
   ...
   bloom[(int(cipher5_text)%58)] += 1
   print(int(cipher5_text))
   #print (int(encrypted5.encode('hex'),16))
   end = datetime.now()
   print end - start
bloom_query([133,235,86,95,46,255,59,63,196,230,175,5,220,141,194,246])
print(bloom)
