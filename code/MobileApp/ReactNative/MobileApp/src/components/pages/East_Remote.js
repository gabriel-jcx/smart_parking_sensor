...
import { AsyncStorage,StyleSheet, Text, View, Image, TouchableWithoutFeedback, StatusBar, TextInput, SafeAreaView, Picker, Keyboard, TouchableOpacity, KeyboardAvoidingView } from 'react-native';
import {StackNavigator} from 'react-navigation';
import { Button } from 'react-native';
import { NativeModules } from 'react-native';

export default class East_Remote extends React.Component {
  // Three different stats existed in this module
  // Data should contain the array of different BLE devices names
  constructor(props){
     super(props);
     this.state ={
        spot: '',
     ...
     NativeModules.ViewController.StartBLE((err,r,p)=>{
        ...
        .then((responseJson)=>{
           ...
           for (i in responseJson.spots){
              ...
              console.log("stared with east remote");
  ...
  render() {
    ...
    return (
      ...
      <Text style={styles.title}> East Remote </Text> 
