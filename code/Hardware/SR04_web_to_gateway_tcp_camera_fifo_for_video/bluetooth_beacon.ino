  ...
  void setBeacon() {
    ...
    oAdvertisementData.setCompleteServices(BLEUUID(beconUUID));
      ...
      beacon_data[3]  = '#'; //sets the MAC address as the URL
      beacon_data[4]  = macAddr[0];
      beacon_data[5]  = macAddr[1];
      beacon_data[6]  = macAddr[2];
      beacon_data[7]  = macAddr[3];
      beacon_data[8]  = macAddr[4];
      beacon_data[9]  = macAddr[5];
      beacon_data[10] = macAddr[6];
      beacon_data[11] = macAddr[7];
      beacon_data[12] = macAddr[8];
      beacon_data[13] = macAddr[9];
      beacon_data[14] = macAddr[10];
      beacon_data[15] = macAddr[11];
